...
const char mySSID[] = "lenovo";
const char myPSK[] = "souju123";
...
// HTTP Strings //
//////////////////
const char destServer[] = "175.101.12.206";
...
const String httpRequest1 ="GET /setsensor.php?login=rakshitha&password=rakshitha&data=";
...
//  serialTrigger(F("Press any key to begin."));
  pinMode(3,OUTPUT);        //------making relay pin as output
  pinMode(11,INPUT);
  pinMode(13,INPUT);
...
void clientDemo()
{
 ...
 // int t;
  ...
  delay(1000);
  //Serial.println(d);
  delay(1000); Serial.println(d);
 client.print(httpRequest1+d+httpRequest2); 
 // } 
